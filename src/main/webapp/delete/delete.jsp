...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/delete/deleteStyle.css">
                            ...
                            <article class="blog-post clearfix">
                                ...
                                <div class="d-grid gap-2 col-2 mx-auto">
                                    <form method="post">
                                        ...
                                        <button class="btn btn-primary" type="button"><a class="link-offset-2 link-underline link-underline-opacity-0 text-light" href="/houses">No</a></button>
                                    </form>
